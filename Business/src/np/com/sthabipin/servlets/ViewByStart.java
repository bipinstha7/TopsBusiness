...
public class ViewByStart extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html>");
		out.println("<head>");
		out.println("<title>View Product by "+start.toUpperCase()+"</title>");
		...
		out.println("<h1>View Product by "+start.toUpperCase()+"</h1>");
		List<ProductsDto> list = ProductsDao.getRecordsByStart(start);
		
		out.print("<table class='table table-bordered table-hover'>");
		out.println("<tr><th>Id</th><th>Name</th><th>Brand</th><th>Weight(Kg)</th><th>Price(Rs)</th><th>Category</th>");
